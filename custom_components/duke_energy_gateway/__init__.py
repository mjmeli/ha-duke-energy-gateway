...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    coordinator = DukeEnergyGatewayDataUpdateCoordinator(hass, client=client)
...
class DukeEnergyGatewayDataUpdateCoordinator(DataUpdateCoordinator):
    """Class to manage fetching data from the API."""

    def __init__(
        self,
        hass: HomeAssistant,
        client: DukeEnergyGatewayApiClient,
    ) -> None:
        """Initialize."""
        self.api = client
        self.platforms = []
